        ...
        <div className="container" style={{ maxWidth: "800px" }}>
          ...
          >
            <Section title="1. Acceptance of Terms">
              <p>
                By accessing or using Uniflow (&quot;the Platform&quot;), you
                agree to be bound by these Terms of Service (&quot;Terms&quot;).
                If you do not agree, you may not use the Platform.
              </p>
              <p>
                These Terms apply to all users, including university
                administrators, lecturers, students, and visitors.
              </p>
            </Section>

            <Section title="2. Description of Service">
              <p>
                Uniflow provides a university timetable and campus management
                platform that enables institutions to manage timetables,
                courses, lecturer assignments, student schedules, and campus
                communications through web and mobile applications.
              </p>
            </Section>
            ...
            <Section title="3. User Accounts and Registration">
              <ul>
                ...
                <li>
                  University registration is subject to review and approval by
                  our team.
                </li>
              </ul>
            </Section>
            ...
            <Section title="4. University Portals">
              <ul>
                <li>
                  Universities receive a dedicated subdomain portal upon
                  approval.
                </li>
                <li>
                  The registering university official certifies they are
                  authorized to represent the institution.
                </li>
                <li>
                  University administrators are responsible for managing access
                  and content within their portal.
                </li>
                <li>
                  We reserve the right to revoke portal access for violations of
                  these Terms.
                </li>
              </ul>
            </Section>
            ...
            <Section title="6. Intellectual Property">
              <p>
                The Platform, including its code, design, logos, and content, is
                owned by Uniflow and protected by intellectual property laws.
            ...
            <Section title="8. Limitation of Liability">
              <p>
                To the maximum extent permitted by law, Uniflow shall not be
                liable for any indirect, incidental, special, consequential, or
                punitive damages arising out of or related to your use of the
                Platform. The Platform is provided &quot;as is&quot; without
            ...
            <Section title="9. Termination">
              <p>
                ...
                Platform at any time, without prior notice, for conduct that we
            ...
            <Section title="11. Governing Law">
              <p>
                ...
                shall be resolved in the courts of Ondo State, Nigeria.
              </p>
            </Section>
