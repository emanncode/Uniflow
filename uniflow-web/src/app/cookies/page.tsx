          ...
          >
            <Section title="1. What Are Cookies">
              <p>
                ...
                used to make websites work efficiently and provide information
                to website owners.
              </p>
            </Section>
            ...
            <Section title="2. How We Use Cookies">
              <p>
                Uniflow uses cookies and similar tracking technologies for the
                following purposes:
              </p>
              <ul>
                <li>
                ...
                <li>
                  ...
                  users interact with our Platform, allowing us to improve
                  performance and features.
                </li>
                <li>
                  <strong>Security Cookies:</strong> Used to detect and prevent
            ...
            <Section title="4. Third-Party Cookies">
              <p>
                We may use third-party services (such as Vercel Analytics) that
                set their own cookies on our Platform. These third parties have
                their own cookie policies. We do not control these cookies.
              </p>
            </Section>
            ...
            <Section title="5. Managing Cookies">
              ...
              <ul>
                ...
                <li>
                  <strong>Consequences:</strong> Please note that blocking
                  essential cookies may affect the functionality of our
                  Platform.
                </li>
              </ul>
            </Section>
