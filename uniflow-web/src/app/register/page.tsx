    ...
    return (
      <main style={{
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, var(--brand-muted) 0%, transparent 65%)',
          pointerEvents: 'none',
        }} />
        <motion.div
  ...
  return (
    <main style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(ellipse, var(--brand-subtle) 0%, transparent 60%)',
        pointerEvents: 'none',
      }} />
            ...
            >
              ...
              {step === 1 ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    <div style={{ position: 'relative' }}>
                      <input
                        ...
                        style={{
                          ...
                          borderColor: form.short_name ? 'var(--border-brand)' : undefined,
                        }}
                      />
                      {form.short_name && (
                        <motion.div
                  ...
                  <motion.button
                    whileHover={{ scale: 1.02, boxShadow: 'var(--shadow-brand)' }}
                    whileTap={{ scale: 0.98 }}
                    onClick={handleNext}
                    className="btn-primary"
                    style={{
