        ...
        <div className="container" style={{ maxWidth: "800px" }}>
          ...
          >
            <Section title="1. Introduction">
              <p>
                Uniflow (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is
                committed to protecting your privacy. This Privacy Policy
                explains how we collect, use, disclose, and safeguard your
                information when you use our platform, website, and mobile
                applications.
              </p>
              <p>
                By using Uniflow, you agree to the collection and use of
            ...
            <Section title="2. Information We Collect">
              ...
              <ul>
                <li>
                  ...
                  phone number, university affiliation, and role when you
                  register or use our services.
                </li>
                <li>
                  <strong>Institutional Information:</strong> University name,
                  short name, official email domain, website, and related
                  details provided during registration.
                </li>
                <li>
                  <strong>Usage Data:</strong> Information about how you access
                  and interact with our platform, including page views, features
                  used, and timestamps.
                </li>
                <li>
            ...
            <Section title="3. How We Use Your Information">
              ...
              <ul>
                ...
                <li>
                  To authenticate users and manage university portal access.
                </li>
                <li>
            ...
            <Section title="4. Data Sharing and Disclosure">
              ...
              <ul>
                ...
                <li>
                  ...
                  vendors to support our operations (e.g., hosting, analytics,
                  email delivery).
                </li>
                <li>
                ...
                <li>
                  <strong>University administration:</strong> Information may be
                  shared with authorized university administrators within your
            ...
            <Section title="6. Data Retention">
              <p>
                ...
                retain certain data longer to comply with legal, tax, or
            ...
            <Section title="11. Changes to This Policy">
              <p>
                ...
                on our platform. Your continued use after changes constitutes
