...
- Mobile app: `uniflow-app` (Expo, React Native) — theme in `uniflow-app/constants/Theme.ts`
- Web admin: `uniflow-web` (Next.js)
- Primary design file: `design/uniflow-mobile.pen` (login + student home screens)
- Starter canvas: `design/starter.pen`
...
Then open `design/uniflow-mobile.pen` in VS Code and restart the agent session.
