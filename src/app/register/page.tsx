...
export default function RegisterPage() {
  ...
  const validateStep1 = () => {
    ...
    if (!form.official_email.includes("@"))
      ...
      >
        <div
          style={{
            ...
            height: "600px",
            background:
              "radial-gradient(circle, rgba(255,92,26,0.08) 0%, transparent 65%)",
            pointerEvents: "none",
          }}
        />
        <motion.div
    ...
    >
      ...
      <div
        style={{
          ...
          height: "500px",
          background:
            "radial-gradient(ellipse, rgba(255,92,26,0.06) 0%, transparent 60%)",
          pointerEvents: "none",
        }}
      />
      ...
      >
        <div style={{ width: "100%", maxWidth: "560px" }}>
          ...
          >
            ...
            >
              Fill out the form below. We'll review your application and set up
              your portal within 48 hours.
            </p>
          </motion.div>
              ...
              {step === 1 ? (
                ...
                >
                  ...
                  <motion.button
                    whileHover={{
                      scale: 1.02,
                      boxShadow: "0 0 30px rgba(255,92,26,0.25)",
                    }}
                    whileTap={{ scale: 0.98 }}
                    onClick={handleNext}
                    className="btn-primary"
                ...
                >
                  ...
                  >
                    ...
                    {[
                      ...
                      {
                        label: "Portal URL",
                        value: `${form.short_name}-admin.uniflow.com.ng`,
                      },
